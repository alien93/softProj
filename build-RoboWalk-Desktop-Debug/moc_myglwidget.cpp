...
#include "../RoboWalk/simulator/myglwidget.h"
...
static const char qt_meta_stringdata_MyGLWidget[] = {
    "MyGLWidget\0\0animation()\0"
    "annElapsedTimer,ann,numOfOutputs\0"
    "animateAnn(QElapsedTimer,ANN*,uint)\0"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->animateAnn((*reinterpret_cast< QElapsedTimer(*)>(_a[1])),(*reinterpret_cast< ANN*(*)>(_a[2])),(*reinterpret_cast< uint(*)>(_a[3]))); break;
        default: ;
        }
    }
}
